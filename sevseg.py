"""Digital clock by Anandu Suresh  sureshanandu202@gmail.com
Display a digital clock of the current time with a seven-segment
display. Press ctrl-C to stop.
More info at http://en.wikipedia.org/wiki/Seven-Segment_display
...
try:
     while True: #Main program loop.
      ...
      print('Digital Clock,by Anandu Suresh sureshanandu202@gmail.com')
      sys.exit() # When Ctrl-C is pressed, end the proram.                 
