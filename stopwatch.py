...
def counter_label(label):
    def count():
        if running:
            ...
            # and then calls the function given as second    
    ...
    #Triggering the start of the stopwatch
    def start (label):
        global running
        running = True
        counter_label(label)
...
#Reset function of the stopwath
def Reset(label):
    global counter
    counter = 0
...
label = Tkinter.Label(root, text='Ready!', fg='black' ,
